...
<?php
	...
	$sql1="SELECT * FROM tenant WHERE email = '".$s_mail."'";
	...
	// 	echo "Property Required ".$row2['status']." <img src=\"Images/tick.png\" height=\"20\" width=\"20\" ><BR>";
	// else
	// 	echo "Property Required ".$row2['status']." <img src=\"Images/cross.png\" height=\"20\" width=\"20\" ><BR>";
	//
	...
	if($row1['status']==$row1['status']){
		echo "<H3>Request to book Property</H3><BR>";
		echo "<input type=\"button\" value=\"Request\" onclick=\"apply_fun('".$job_id."','".$s_mail."','".$row2['company_name']."',this)\">";
	}else{
